    	...
    	<!-- Begin of toolbar -->
	       <div id="wu-toolbar">
				...
				<div class="wu-toolbar-search">
	                <label>内部订单编号：</label><input id="int_order_no" class="wu-text" style="width:100px">
...
<script type="text/javascript">
	...
	function refresh(currPage)
	{
		...
		// 
		var condition = [
			{"condition_key":"int_order_no","condition_value":$("#int_order_no").val(),"condition_type":"string"},
		...
		$.ajax({
            ...
            success:function(data){
	    			...
	    			$.each(rows,function(index,d){
	    				// 拼接联合主键的ID
	    				var idObj = d.int_order_no+"-"+d.prod_no;
	    				// 要添加的行内容
	    				var rowElements="<tr>"+
            ...
            success:function(data){
                ...
                $(data.rows).each(function(index,element){
                    ...
                    var obj = {
                        ...
                        "int_order_remark":element.int_order_remark,
                    };
                    // 将JSON对象添加到数组
                    objs.push(obj);
                });
