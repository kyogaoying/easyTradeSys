    ...
    <div id="mainBody">
      ...
      <form>
		  <div id="documentHeading">
			<div> 
				<span id="buyerInfo"> 
					Buyer name: ${packingListInfos[0].customer_name}<br/><br/>
					Add: <span id="add">${packingListInfos[0].address}</span><br/><br/>
					Tel: <span id="tel">${packingListInfos[0].tel}</span>
				</span> 
				<span id="packingListInfo">
				  PackingList No.: <span id="packingListNo">${packingListInfos[0].packing_list_no}</span><br/><br/>
				  Date: <span id="packingListDate">${packingListInfos[0].packing_list_date}</span>
				</span> 
			</div>
		  </div>
		  <!-- Begin of table -->
...
<script type="text/javascript">
	...
	*/
	...
	function getTotal(){
		...
		$("#ttl").text("Total: "+totalGW+"KGS"+"      "+totalVolume+"CBM");
