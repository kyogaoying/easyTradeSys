    ...
    <div id="mainBody">
      ...
      <form>
		  <div id="documentHeading">
			<div> 
				<span id="buyerInfo"> 
					Buyer name: ${invoiceInfos[0].customer_name}<br/><br/>
					Add: <span id="add">${invoiceInfos[0].address}</span><br/><br/>
					Tel: <span id="tel">${invoiceInfos[0].tel}</span>
				</span> 
				<span id="quotationInfo"> 
				  Invoice No.: <span id="invoiceNo">${invoiceInfos[0].invoice_no}</span><br/><br/>
				  Date: <span id="invoiceDate">${invoiceInfos[0].invoice_date}</span>
				</span> 
			</div>
		  </div>
		  <!-- End of header --> 
