...
<script type="text/javascript">
	...
	function save()
	{
		...
		if(actionType == "add")
		{
			...
			$(".addRow").each(function(index,element){
				...
				var user_no = $(element).find("input[name='user_no']").val();
				...
				$.messager.confirm('信息提示','确定要删除记录？', function(result){
					...
					if(result){
						...
						$(checkedItems).each(function(index,element){
							...
							var obj = {"role_no":id_arr[0],"user_no":id_arr[1]};
							ids.push(obj);	
						});
						// 将标识变为delete
						actionType = "delete";
	...
	function openAdd(){
		...
		var rowElements="<tr class='addRow'>"+
							...
							"<td><input type='text' name='user_no' class='userManagement' onclick='pop(this)' /></td>"+
